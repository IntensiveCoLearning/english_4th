...
Currently endeavoring to aquire a IELTS 6.5+ degree
...
## **Daily accumulation 21**

-   **_preeminent_** $\\leftarrow$ outstanding/distinguished
...
## **Daily accumulation 20**

-   **_stationery&sationary:_** $\\leftarrow$ representing writing paper&office supplies and motionless&immobile respectively
    
-   **_impulse_** $\\leftarrow$ whim, urge, inclination, motivation
    
-   **_incapacitate_** $\\leftarrow$ disable,disqualify
...
## **Daily accumulation 18**

-   **_bucolic_** $\\leftarrow$ idyllic/pastoral/rural
    
-   **_repress/supress/subdue/stifle_**
...
-   雅思出分小摆一天
    ...
    ![ed2cba9551dda6c32390da2bf5a92643.png](https://raw.githubusercontent.com/IntensiveCoLearning/english_4th/main/assets/klizz111/images/2026-03-11-1773233155529-ed2cba9551dda6c32390da2bf5a92643.png)
...
-   **_seclusion_** $\\leftarrow$ solitude,actively live alone
    
-   **_instantaneously_** $\\leftarrow$ instantly/immediately/swiftly
...
-   **_peerminent_** $\\leftarrow$ outstanding/superior
...
-   **_shimmer/sparkling/glisten_**
    
-   **_pellucid/transparent/clear/obvious_**
...
-   **_inadequacy_** $\\leftarrow$ insufficient or weakness/defect
    
-   **_radical_** $\\leftarrow$ fundamental/basic/total
    
-   **_neonatal_** $\\leftarrow$ new-born
...
-   **_vet/inspect/treat/check_**
    
-   **_landform/terrain_**
    
-   **_imminent_** $\\leftarrow$ coming or likely to happen very soon - **_imminently_** $\\leftarrow$ urgently
...
-   **_hype-d_** $\\leftarrow$ relatively over promoting with some exaggerated facts
    
-   **_invaluable_** $\\leftarrow$ to describe something whose value can't be assess or extremely precious
    
-   **_commotion-rebellion-agitation_**
...
-   _innominate_ $\\leftarrow$ anonymous
    
-   _lessen_ $\\leftarrow$ decrease
...
-   monopolize: nowadays, the super enterprise have monopolized ours private information
    
-   enlighten: could substitute inspire or teach
    
-   torture/afflict/torment
...
-   maneuver - n/v - 演习, 策略/similar to tactics/strategy
